...
local info = {
    ...
    ethinfo: s.record("EthStats", [
        s.field("ipackets", self.uint8, 0, doc="Received packets"),
        s.field("opackets", self.uint8, 0, doc="Transmitted packets"),
        s.field("ibytes", self.uint8, 0, doc="Received bytes"),
        s.field("obytes", self.uint8, 0, doc="Transmitted bytes"),
        s.field("imissed", self.uint8, 0, doc="Missed packets"),
        s.field("ierrors", self.uint8, 0, doc="Receiver errors"),
        s.field("oerrors", self.uint8, 0, doc="Output Errors"),
        s.field("rx_nombuf", self.uint8, 0, doc="Number of Rx mbuf allocation failures"),

        ], doc="NIC Stats information"),

    info: s.record("EthXStats", [
