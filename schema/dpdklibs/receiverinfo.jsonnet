...
local info = {
   ...
   info: s.record("Info", [
       ...
       s.field("bad_seqid_packets_per_second", self.double8, -999, doc="Packets/s with an unexpected sequence ID"),
       s.field("max_bad_seqid_deviation", self.int8, -999, doc="Largest difference found between expected and actual packet sequence ID"),
