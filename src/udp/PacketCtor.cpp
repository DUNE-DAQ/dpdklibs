...
static bool
get_ether_addr6(const char* s0, struct rte_ether_addr* ea)
{
  const char* s = s0;
  int i;
...
/**************************************************************************/ /**
                                                                              *
                                                                              * pktgen_udp_hdr_ctor - UDP header
                                                                              * constructor routine.
                                                                              *
                                                                              * DESCRIPTION
                                                                              * Construct the UDP header in a packer
                                                                              * buffer.
                                                                              *
...
/**************************************************************************/ /**
                                                                              *
                                                                              * pktgen_ipv4_ctor - Construct the IPv4
                                                                              * header for a packet
                                                                              *
                                                                              * DESCRIPTION
                                                                              * Constructor for the IPv4 header for a
                                                                              * given packet.
                                                                              *
                                                                              * RETURNS: N/A
                                                                              *
...
/**************************************************************************/ /**
                                                                              *
                                                                              * pktgen_ether_hdr_ctor - Ethernet header
                                                                              * constructor routine.
                                                                              *
                                                                              * DESCRIPTION
                                                                              * Construct the ethernet header for a
                                                                              * given packet buffer.
                                                                              *
                                                                              * RETURNS: Pointer to memory after the
                                                                              * ethernet header.
                                                                              *
                                                                              * SEE ALSO:
                                                                              */
...
pktgen_ether_hdr_ctor(struct ipv4_udp_packet_hdr* packet_hdr)
{
  ...
  /* src and dest addr */
  // See definition dpdk-20.08/lib/librte_net/rte_ether.c is defined as static -> not exposed to the lib... redefining
  // here
